...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 44 | GHSA-95m3-7q98-8xr5 | critical | npm | `sha.js` | transitive / runtime | `2.4.11` | `2.4.12` | PGL | `sha.js@2.4.11 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | validated locally; PR #201 open |
...
| 3 | GHSA-pwfr-8pq7-x9qv | high | npm | `octokit` | transitive / runtime | `3.1.1` | `3.1.2` | PGL | `octokit@3.1.1 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | validated locally; PR #201 open |
| 11 | GHSA-9wv6-86v2-598j | high | npm | `path-to-regexp` | transitive / runtime | `0.1.7` | `0.1.10` | PGL + WEBEXT + WPS | `path-to-regexp@0.1.7 ← express@4.19.2 ← @php-wasm/web@1.0.13 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | PGL path removed; vulnerable WEBEXT + WPS paths remain; PR #201 open |
| 13 | GHSA-qwcr-r2fm-qrc7 | high | npm | `body-parser` | transitive / runtime | `1.20.2` | `1.20.3` | PGL + WEBEXT + WPS | `body-parser@1.20.2 ← express@4.19.2 ← @php-wasm/web@1.0.13 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | PGL path removed; vulnerable WEBEXT + WPS paths remain; PR #201 open |
| 23 | GHSA-rhx6-c78j-4q9w | high | npm | `path-to-regexp` | transitive / runtime | `0.1.7` | `0.1.12` | PGL + WEBEXT + WPS | `path-to-regexp@0.1.7 ← express@4.19.2 ← @php-wasm/web@1.0.13 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | PGL path removed; vulnerable WEBEXT + WPS paths remain; PR #201 open |
| 56 | GHSA-869p-cjfg-cm3x | high | npm | `jws` | transitive / runtime | `3.2.2` | `3.2.3` | PGL | `jws@3.2.2 ← jsonwebtoken@9.0.2 ← universal-github-app-jwt@1.2.0 ← @octokit/auth-app@6.1.3 ← @octokit/app@14.1.0 ← octokit@3.1.1 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | validated locally; PR #201 open |
...
| 99 | GHSA-37ch-88jc-xwx2 | high | npm | `path-to-regexp` | transitive / runtime | `0.1.7` | `0.1.13` | PGL + WEBEXT + WPS | `path-to-regexp@0.1.7 ← express@4.19.2 ← @php-wasm/web@1.0.13 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | PGL path removed; vulnerable WEBEXT + WPS paths remain; PR #201 open |
| 153 | GHSA-96hv-2xvq-fx4p | high | npm | `ws` | transitive / runtime | `8.18.0` | `8.21.0` | BLK + PGL + WEBEXT + WPS | `ws@8.18.0 ← @php-wasm/web@1.0.13 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | PGL path removed; vulnerable BLK + WEBEXT + WPS paths remain; PR #201 open |
...
| 29 | GHSA-x4c5-c7rf-jjgv | medium | npm | `@octokit/endpoint` | transitive / runtime | `9.0.5` | `9.0.6` | PGL | `@octokit/endpoint@9.0.5 ← @octokit/request@8.4.0 ← @octokit/core@5.2.0 ← octokit@3.1.1 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | validated locally; PR #201 open |
| 30 | GHSA-xx4v-prfh-6cgc | medium | npm | `@octokit/request-error` | transitive / runtime | `5.1.0` | `5.1.1` | PGL | `@octokit/request-error@5.1.0 ← octokit@3.1.1 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | validated locally; PR #201 open |
| 31 | GHSA-h5c3-5r3r-rr8q | medium | npm | `@octokit/plugin-paginate-rest` | transitive / runtime | `9.2.1` | `9.2.2` | PGL | `@octokit/plugin-paginate-rest@9.2.1 ← octokit@3.1.1 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | validated locally; PR #201 open |
| 32 | GHSA-rmvr-2pp2-xj38 | medium | npm | `@octokit/request` | transitive / runtime | `8.4.0` | `8.4.1` | PGL | `@octokit/request@8.4.0 ← @octokit/core@5.2.0 ← octokit@3.1.1 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | validated locally; PR #201 open |
| 57 | GHSA-6rw7-vpxm-498p | medium | npm | `qs` | transitive / runtime | `6.11.0` | `6.14.1` | PGL + WEBEXT + WPS | `qs@6.11.0 ← express@4.19.2 ← @php-wasm/web@1.0.13 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | PGL path removed; vulnerable WEBEXT + WPS paths remain; PR #201 open |
...
| 72 | GHSA-2g4f-4pwh-qvx6 | medium | npm | `ajv` | transitive / runtime | `8.12.0` | `8.18.0` | AJV + PGL + WEBEXT + WEBPACK + WPS | `ajv@8.12.0 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | PGL path removed; vulnerable AJV + WEBEXT + WEBPACK + WPS paths remain; PR #201 open |
...
| 132 | GHSA-58qx-3vcg-4xpx | medium | npm | `ws` | transitive / runtime | `8.18.0` | `8.20.1` | BLK + PGL + WEBEXT + WPS | `ws@8.18.0 ← @php-wasm/web@1.0.13 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | PGL path removed; vulnerable BLK + WEBEXT + WPS paths remain; PR #201 open |
...
| 15 | GHSA-qw6h-vgh9-j6wx | low | npm | `express` | transitive / runtime | `4.19.2` | `4.20.0` | PGL + WEBEXT + WPS | `express@4.19.2 ← @php-wasm/web@1.0.13 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | PGL path removed; vulnerable WEBEXT + WPS paths remain; PR #201 open |
| 16 | GHSA-cm22-4g7w-348p | low | npm | `serve-static` | transitive / runtime | `1.15.0` | `1.16.0` | PGL + WEBEXT + WPS | `serve-static@1.15.0 ← express@4.19.2 ← @php-wasm/web@1.0.13 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | PGL path removed; vulnerable WEBEXT + WPS paths remain; PR #201 open |
| 17 | GHSA-m6fv-jmcg-4jfg | low | npm | `send` | transitive / runtime | `0.18.0` | `0.19.0` | PGL + WEBEXT + WPS | `send@0.18.0 ← express@4.19.2 ← @php-wasm/web@1.0.13 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | PGL path removed; vulnerable WEBEXT + WPS paths remain; PR #201 open |
| 18 | GHSA-pxg6-pf52-xh8x | low | npm | `cookie` | transitive / runtime | `0.6.0` | `0.7.0` | PGL + WEBEXT + WPS | `cookie@0.6.0 ← express@4.19.2 ← @php-wasm/web@1.0.13 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | PGL path removed; vulnerable WEBEXT + WPS paths remain; PR #201 open |
...
| 68 | GHSA-w7fw-mjwx-w883 | low | npm | `qs` | transitive / runtime | `6.11.0` | `6.14.2` | PGL + WEBEXT + WPS | `qs@6.11.0 ← express@4.19.2 ← @php-wasm/web@1.0.13 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | PGL path removed; vulnerable WEBEXT + WPS paths remain; PR #201 open |
| 171 | GHSA-v422-hmwv-36x6 | low | npm | `body-parser` | transitive / runtime | `1.20.2` | `1.20.6` | PGL + WEBEXT + WPS | `body-parser@1.20.2 ← express@4.19.2 ← @php-wasm/web@1.0.13 ← @wp-playground/client@1.0.13` | [#201](https://github.com/WordPress/try-wordpress/pull/201) | published PGL lock path removed, but bundled source remains vulnerable through current release; WEBEXT + WPS paths also remain; upstream blocked; PR #201 open |
...
Status: validated locally; child pull request [#201](https://github.com/WordPress/try-wordpress/pull/201) is open against the integration branch.
